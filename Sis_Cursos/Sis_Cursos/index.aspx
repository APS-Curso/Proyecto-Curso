...
<body>
    <form id="form1" runat="server" class="form-signin">
        <div class="text-center mb-4">
         ...
         <p><asp:HyperLink ID="hplOlvideContrasena" runat="server" NavigateUrl="~/Interfaces/Olvide_Contrasena/OlvideContrasena.aspx">Olvide mi contraseña</asp:HyperLink></p>
